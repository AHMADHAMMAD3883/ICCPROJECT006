...
#-----------splash_screen------------------------------------------------------------------------------------------------------------------
sroot = Tk()
sroot.minsize(height=516,width=750)
...
#chilanka
Label(sroot,text="Hotel Management System ",font='Timesnewroman 40 ',bg='white',fg='black').place(x=100,y=10)
Label(sroot,text="Made by -",font='Timesnewroman 40 ',bg='white',fg='black').place(x=100,y=90)
Label(sroot,text="AHMAD HAMMAD",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=100,y=180)
Label(sroot,text="01-134181-006",font='Timesnewroman 40',bg='white',fg='grey').place(x=100,y=270)
...
def mainroot():
	...
	def staff():
		...
		Label(emp1inf,text="AHMAD HAMMAD",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		...
		Label(emp1inf,text="AREEB",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		...
		Label(emp1inf,text="HANNAN",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		...
		Label(emp1inf,text="ALI",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
